...
var bkLib = {
    ...
    onDomLoaded: function(A) {
        ...
        if (document.addEventListener) { document.addEventListener("DOMContentLoaded", bkLib.domLoaded, null) } else {
            if (bkLib.isMSIE) {
                document.write("<style>.nicEdit-main p { margin: 0; }</style><script id=__ie_onload defer " + ((location.protocol == "corporate%20profile.html") ? "src='javascript:void(0)'" : "src=//0") + "><\/script>");
...
var nicUploadButton = nicEditorAdvancedButton.extend({
    ...
    uploadFile: function() {
        ...
        C.open("POST.html", this.ne.options.uploadURI || this.nicURI);
        C.onload = function() {
